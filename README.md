### API Gateway Responses [![Build Status](https://travis-ci.org/drexler/gateway-responses.svg?branch=master)](https://travis-ci.org/drexler/gateway-responses.svg?branch=master)
